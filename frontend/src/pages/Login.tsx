/**
 * Login.tsx — Écran de connexion HR.
 */
...
export default function Login(): JSX.Element {
    ...
    return (
        <div className="min-h-screen flex">
            {/* Panneau gauche — identité produit + animation signature */}
            <div className="hidden lg:flex lg:w-1/2 bg-ink relative overflow-hidden flex-col justify-between p-12">
                ...
                <div className="relative z-10 max-w-sm">
                    <h1 className="font-display font-semibold text-3xl text-white leading-tight mb-3">
                        Le bon candidat,<br />trouvé plus vite.
                    </h1>
                    <p className="text-white/60 text-sm leading-relaxed">
                        SkanCV lit chaque CV, en extrait les compétences réelles et
                        les compare à vos offres — pour que vous passiez votre temps
                        sur les entretiens, pas sur le tri.
                    </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center bg-paper px-6">
                <form onSubmit={handleSubmit} className="w-full max-w-sm">
                    ...
                    <h2 className="font-display font-semibold text-2xl text-ink mb-1">Bon retour</h2>
                    <p className="text-sm text-muted mb-6">Connectez-vous à votre espace RH.</p>
                    ...
                    <div className="text-center">
                        <p className="text-sm text-muted">
                            ...
                            <Link to="/register" className="text-signal hover:text-signal-dark font-medium transition">
                                S'inscrire
                            </Link>
                        </p>
                    </div>
